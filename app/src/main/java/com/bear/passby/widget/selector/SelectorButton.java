package com.bear.passby.widget.selector;
...
public class SelectorButton extends View {
    ...
    public SelectorButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTextColor = typedArray.getColor(R.styleable.SelectorButton_text_color, getResources().getColor(R.color.colorGreenScallionLight));
    ...
    private void init() {
        ...
        mCheckedColor = getResources().getColor(R.color.colorGreenScallionDeep);
