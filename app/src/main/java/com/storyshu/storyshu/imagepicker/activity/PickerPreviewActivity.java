...
import com.storyshu.storyshu.imagepicker.util.FileUtil;
import com.storyshu.storyshu.imagepicker.util.ImageUtil;
import com.storyshu.storyshu.imagepicker.util.SystemUtil;
import com.storyshu.storyshu.imagepicker.widget.CheckBox;
import com.storyshu.storyshu.imagepicker.widget.PickerBottomLayout;
import com.storyshu.storyshu.imagepicker.widget.PicturePreviewPageView;
import com.storyshu.storyshu.imagepicker.widget.PreviewViewPager;
import com.storyshu.storyshu.imagepicker.widget.subsamplingview.ImageSource;
import com.storyshu.storyshu.imagepicker.widget.subsamplingview.OnImageEventListener;
...
public class PickerPreviewActivity extends BasePickerActivity implements PickerAction {
     ...
     * 底部栏的点击事件
     */
    private PickerBottomLayout.OnBottomListener onBottomListener = new PickerBottomLayout.OnBottomListener() {
        @Override
        public void onSelectClicked(boolean isChecked) {
            ...
            if (isCountOver() && !selected.contains(filePath)) {
                ...
                return;
            } else if (selected.contains(filePath)) {
    ...
    private void initUI() {
        ...
        bottomLayoutHeight = getResources().getDimensionPixelSize(R.dimen.title_height);
        ...
        previewBottomLayout.setOnBottomListener(onBottomListener);

        checkBox = previewBottomLayout.selectBox;
