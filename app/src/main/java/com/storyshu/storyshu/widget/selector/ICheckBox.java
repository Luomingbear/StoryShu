...
public class ICheckBox extends View {
    ...
    public ICheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        disabledColor =
                a.getColor(R.styleable.ICheckBox_disabled_color,
                        getResources().getColor(R.color.colorGray));
        borderColor =
                a.getColor(R.styleable.ICheckBox_border_color, Color.WHITE);
        size = a.getDimensionPixelSize(R.styleable.ICheckBox_checkbox_size, DipPxConversion.dip2px(getContext(), 22));
        unchecked_invisible = a.getBoolean(R.styleable.ICheckBox_invisible_in_unchecked_state, false);
        checkDrawable = a.getDrawable(R.styleable.ICheckBox_checked_drawable);
        showBorderInCheckState = a.getBoolean(R.styleable.ICheckBox_show_border_in_check_state, false);
        a.recycle();
        init();
    }
