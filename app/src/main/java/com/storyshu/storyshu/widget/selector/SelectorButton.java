...
public class SelectorButton extends View {
    ...
    private boolean needDrawable = true; //是否需要图标
    ...
    public SelectorButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTextColor = typedArray.getColor(R.styleable.SelectorButton_text_color, getResources().getColor(R.color.colorGrayDeep));
        ...
        needDrawable = typedArray.getBoolean(R.styleable.SelectorButton_need_drawable, true);
        typedArray.recycle();
