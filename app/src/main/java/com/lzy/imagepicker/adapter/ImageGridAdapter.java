...
import com.storyshu.storyshu.widget.selector.ICheckBox;
...
public class ImageGridAdapter extends BaseAdapter {
            ...
            holder.cbCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mSelectedImages.size() >= selectLimit) {
                        ...
                        holder.cbCheck.setChecked(false, true);
                        ...
                        if (!holder.cbCheck.isChecked()) {
                            //没有选择
                            holder.cbCheck.setText(mSelectedImages.size() + 1 + "");
                            holder.cbCheck.setChecked(true, true);
    ...
    private class ViewHolder {
        ...
        public View mask;
        public ICheckBox cbCheck;

        public ViewHolder(View view) {
            rootView = view;
            ivThumb = (ImageView) view.findViewById(R.id.iv_thumb);
            mask = view.findViewById(R.id.mask);
            cbCheck = (ICheckBox) view.findViewById(R.id.cb_check);
        }
    }
